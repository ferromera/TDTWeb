module TeamsHelper
  def matchEmblem team
      ...
      when team.name.downcase == "wisconsin badgers" then "/assets/teams/WB.png"
      when team.name.downcase == "comando superior peronista" then "/assets/teams/CS.png"
      when team.name.downcase == "saint bastian" then "/assets/teams/SB.png"
      when team.name.downcase == "deportivo fiesta" then "/assets/teams/DF.png"
